...
public class SokajyDetail15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sokajy_detail15);
        getSupportActionBar().setTitle("    ");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        //this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);


        TextView titre=(TextView) findViewById(R.id.textViewTitleSokajyDetail15);
        TextView nom=(TextView) findViewById(R.id.textViewNameSokajyDetail15);
        parole=(TextView) findViewById(R.id.textViewParoleSokajyDetail15);
        ...
        //==== for zoom ==============================================================//
        scrollView=(ScrollView)findViewById(R.id.scrollView15);
