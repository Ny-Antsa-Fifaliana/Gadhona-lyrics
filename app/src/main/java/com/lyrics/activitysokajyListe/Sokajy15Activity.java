...
public class Sokajy15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sokajy15);
        getSupportActionBar().setTitle("Hira 15 em Anniversaire");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Log.d("Tiiiiitreeeee", "aplle lister sokajy 15");
       // this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        SearchView bar;
        lst= (ListView) findViewById(R.id.lstSokajy15);
        bar=(SearchView)findViewById(R.id.searchViewSokajy15);
        ...
        List<SokajyBean> objetExtrat= ctrl.listeObjetLyricsSokajy15();
        ...
        adapter= new SimpleAdapter(Sokajy15Activity.this,p.value,R.layout.itemlyrics,
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent inten=new Intent(Sokajy15Activity.this, SokajyDetail15Activity.class);
        ...
        bar.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Sokajy15Activity.this.adapter.getFilter().filter(query);
                return false;
            }

            @Override
            public boolean onQueryTextChange(String newText) {
                Sokajy15Activity.this.adapter.getFilter().filter(newText);
                return false;
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.itemParameterMenu:
                Intent iParam=new Intent(Sokajy15Activity.this, ParameterActivity.class);
